import { BlindedCommitmentData, POIEventType, POIStatus, TXIDVersion } from '@railgun-community/shared-models';
...
export type POIEvent = POIEventShield | POIEventTransact | POIEventUnshield | POIEventLegacyTransact;
